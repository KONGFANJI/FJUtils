...
/**
 清空缓存
 */
+ (void)cleanCaches:(void(^)(BOOL isSuccess))CompleteBlock exclude:(NSString *)folderName;
 ...
 */
+ (void)cleanCachesAtPath:(NSString *)path exclude:(NSString *)folderName completeBlock:(void(^)(BOOL isSuccess))CompleteBlock;
